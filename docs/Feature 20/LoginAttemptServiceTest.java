...
class LoginAttemptServiceTest {
  ...
  void recordLoginAttempt_Success_ShouldSave() {
    ...
    loginAttemptService.recordLoginAttempt("testuser", true, null, "127.0.0.1", "Chrome");
  ...
  void recordLoginAttempt_Failed_ShouldSave() {
    ...
    loginAttemptService.recordLoginAttempt("testuser", false, "Invalid credentials", "192.168.1.1", null);
  ...
  void recordLoginAttempt_UnknownUser_ShouldSaveWithNullUser() {
    ...
    loginAttemptService.recordLoginAttempt("unknown", false, "User not found", null, null);
