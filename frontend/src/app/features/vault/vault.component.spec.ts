...
describe('VaultComponent', () => {
  ...
  beforeEach(async () => {
    mockVaultService = jasmine.createSpyObj('VaultService', ['getAllEntries', 'getEntry', 'toggleFavorite', 'deleteEntry']);
  ...
  it('should filter entries based on sidebar selection', () => {
    ...
    component.onFilterSelected({ type: 'system', name: 'favorites' });
