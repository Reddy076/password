 ...
 *
 * <p>The encryption key is generated fresh for each share and returned to the caller
 * to be embedded in the share URL fragment. It is <em>never persisted</em> on the server —
...
public class ShareEncryptionService {
     ...
     * @return a {@link ShareEncryptionResult} containing ciphertext, IV, and the raw key
     */
    ...
    public static class ShareEncryptionResult {
        ...
        private String iv;
        /** The one-time AES key in Base64 — must be sent to the client, never stored server-side */
