...
@WebMvcTest(controllers = VaultTimelineController.class,
        excludeAutoConfiguration = {UserDetailsServiceAutoConfiguration.class})
class VaultTimelineControllerTest {

    @Autowired private MockMvc mockMvc;

    @MockBean private VaultTimelineService timelineService;
    ...
    void setUp() {
        Mockito.when(rateLimitService.isAllowed(ArgumentMatchers.anyString(), ArgumentMatchers.anyString()))
                .thenReturn(true);
        Mockito.when(rateLimitService.getRemainingRequests(ArgumentMatchers.anyString(), ArgumentMatchers.anyString()))
                .thenReturn(100);
