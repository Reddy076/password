...
class CategoryControllerTest {
  ...
  void setUp() {
    org.mockito.Mockito.when(
        rateLimitService.isAllowed(org.mockito.ArgumentMatchers.anyString(), org.mockito.ArgumentMatchers.anyString()))
        .thenReturn(true);
  ...
  class CreateCategoryTests {
    ...
    void createCategory_DuplicateName_BadRequest() throws Exception {
      when(categoryService.createCategory(any(CreateCategoryRequest.class), eq("testuser")))
          .thenThrow(new IllegalArgumentException("Category with name 'New Category' already exists"));
  ...
  class UpdateCategoryTests {
    ...
    void updateCategory_Success() throws Exception {
      ...
      verify(categoryService).updateCategory(eq(1L), any(CreateCategoryRequest.class), eq("testuser"));
    }
  ...
  class GetEntriesInCategoryTests {
    ...
    void getEntriesInCategory_ReturnsEntries() throws Exception {
      ...
      when(vaultService.getEntriesByCategory("testuser", 1L)).thenReturn(Collections.singletonList(entry));
