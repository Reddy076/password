...
class SecurityMetricsCalculatorTest {
    ...
    void computeOverallScore_AllStrong_ShouldReturn100OrNear() {
        int score = calculator.computeOverallScore(5, 0, 0, 0, 5, 0);
        assertEquals(100, score);
    }

    @Test
    void computeOverallScore_AllWeak_ShouldBeVeryLow() {
        int score = calculator.computeOverallScore(5, 5, 0, 0, 0, 0);
        assertTrue(score <= 60);
    }

    @Test
    void computeOverallScore_EmptyVault_ShouldReturn100() {
        int score = calculator.computeOverallScore(0, 0, 0, 0, 0, 0);
        assertEquals(100, score);
    }

    @Test
    void computeOverallScore_NeverNegative() {
        int score = calculator.computeOverallScore(10, 10, 10, 10, 0, 0);
        assertTrue(score >= 0);
    }

    @Test
    void computeOverallScore_NeverAbove100() {
        int score = calculator.computeOverallScore(5, 0, 0, 0, 5, 5);
